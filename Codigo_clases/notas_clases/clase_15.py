#Tipo de Dato Abstracto -TDA-: listas	Manejo de listas mediante métodos de python. Búsquedas.
lista_1 = [1, 2, 3, 4, 5, 6]
lista_2 = ["a", "b", "c", "d"]
...
print(f"ID lista_2 = {id(lista_2)}") #lista_2 = 2257951854976
print()

copia_lista_2 = copy.copy(lista_2)
print(f"copia_lista_2 = {copia_lista_2}") #copia_lista_2 = ['a', 'b', 'c', 'd']
print(f"ID copia_lista_2 = {id(copia_lista_2)}") #copia_lista_2 = 2257952143808
...
print(f"lista_2 = {lista_2}") #lista_2 = ['a', 'b', 'c', 'd']
print(f"ID lista_2 = {id(lista_2)}") #lista_2 = 2194000056704
print()

copia_lista_2 = copy.deepcopy(lista_2)
print(f"copia_lista_2 = {copia_lista_2}") #copia_lista_2 = ['a', 'b', 'c', 'd']
print(f"ID copia_lista_2 = {id(copia_lista_2)}") #copia_lista_2 = 2194000345536


#Ambas formas toman diferentes espacios de memoria, pero en Shallow copy modificaríamos la lista original. En cambio usando deepcopy, creamos una lista completamente nueva, con los mismos objetos. 
...
#Enumerate muestra el índice y el valor:
...
#Github de Manu: https://github.com/Mansama18-code/python-c2-2025-ejercicios
